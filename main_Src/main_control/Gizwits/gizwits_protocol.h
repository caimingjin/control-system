...
* @{
*/
#define PRODUCT_KEY "d1ab3f5b399c47e28e9c8c77938ac14f"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f0a7b306d915499d9296e5d5fc17f615"
...
* @{
*/
#define AIR_Power_BYTEOFFSET                    0
#define AIR_Power_BITOFFSET                     0
#define AIR_Power_LEN                           1
#define Light_Power_BYTEOFFSET                    0
#define Light_Power_BITOFFSET                     1
#define Light_Power_LEN                           1
#define TV_Power_BYTEOFFSET                    0
#define TV_Power_BITOFFSET                     2
#define TV_Power_LEN                           1
#define AIR_Model_BYTEOFFSET                    0
#define AIR_Model_BITOFFSET                     3
#define AIR_Model_LEN                           2

#define AIR_temper_RATIO                         1
#define AIR_temper_ADDITION                      0
#define AIR_temper_MIN                           0
#define AIR_temper_MAX                           13
#define Light_level_RATIO                         1
#define Light_level_ADDITION                      0
#define Light_level_MIN                           0
#define Light_level_MAX                           2
#define TV_Channel_RATIO                         1
#define TV_Channel_ADDITION                      0
#define TV_Channel_MIN                           0
#define TV_Channel_MAX                           99
#define Light_Num_RATIO                         1
#define Light_Num_ADDITION                      0
#define Light_Num_MIN                           0
#define Light_Num_MAX                           7
#define TV_NOW_Channel_RATIO                         1
#define TV_NOW_Channel_ADDITION                      0
#define TV_NOW_Channel_MIN                           0
#define TV_NOW_Channel_MAX                           99
/**@} */
...
typedef enum
{
    AIR_Model_VALUE0 = 0,//0.自动
    AIR_Model_VALUE1 = 1,//  1.制冷
    AIR_Model_VALUE2 = 2,// 2.抽湿
    AIR_Model_VALUE3 = 3,// 3.制热
    AIR_Model_VALUE_MAX,
} AIR_Model_ENUM_T;
...
typedef struct {
  bool valueAIR_Power;
  bool valueLight_Power;
  bool valueTV_Power;
  uint32_t valueAIR_Model;
  uint32_t valueAIR_temper;
  uint32_t valueLight_level;
  uint32_t valueTV_Channel;
  uint32_t valueLight_Num;
  uint32_t valueTV_NOW_Channel;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagAIR_Power:1;
  uint8_t flagLight_Power:1;
  uint8_t flagTV_Power:1;
  uint8_t flagAIR_Model:1;
  uint8_t flagAIR_temper:1;
  uint8_t flagLight_level:1;
  uint8_t flagTV_Channel:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueAIR_temper;
  uint8_t valueLight_level;
  uint8_t valueTV_Channel;
} attrVals_t;
...
typedef struct {
  ...
  uint8_t valueLight_level;
  uint8_t valueTV_Channel;
  uint8_t valueLight_Num;
  uint8_t valueTV_NOW_Channel;
} devStatus_t; 
